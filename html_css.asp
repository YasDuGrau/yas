...
<a target="_top" href="html_xhtml.asp" class="not-wired">HTML vs. XHTML</a>
<br>
...
<a target="_top" href="html_form_attributes_form.asp" class="not-wired">Input Form Attributes</a>
<br>
<h2 class="left"><span class="left_h2">HTML</span> Graphics</h2>
<a target="_top" href="html5_canvas.asp">HTML Canvas</a>
<a target="_top" href="html5_svg.asp" class="not-wired">HTML SVG</a>
<br>
...
<a target="_top" href="html_youtube.asp" class="not-wired">HTML YouTube</a>
<br>
...
<a target="_top" href="html5_serversentevents.asp" class="not-wired">HTML SSE</a>
<br>
...
<a class="w3-left w3-btn" href="html_colors_hsl.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_links.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">CSS stands for Cascading Style Sheets.</p>
<p class="intro">CSS saves a lot of work. It can control the layout of multiple 
...
<ul>
  <li><strong>Inline</strong> - by using the <code class="w3-codespan">style</code> attribute inside HTML elements</li>
  ...
  <li><strong>External</strong> - by using a <code class="w3-codespan">&lt;link&gt;</code> 
...
<p>An inline CSS uses the <code class="w3-codespan">style</code> attribute of an HTML element.</p>
<p>The following example sets the text color of the <code class="w3-codespan">&lt;h1&gt;</code> element to blue, 
and the text color of the <code class="w3-codespan">&lt;p&gt;</code> element to red:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;h1 style=&quot;color:blue;&quot;&gt;A Blue Heading&lt;/h1&gt;<br><br>&lt;p 
  style=&quot;color:red;&quot;&gt;A red paragraph.&lt;/p&gt;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_css_inline" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>The following example sets the text color of ALL the <code class="w3-codespan">&lt;h1&gt;</code> elements 
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_css_internal" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>External CSS</h2>
<p>An external style sheet is used to define the style for many HTML pages.</p>
<p>To use an external style sheet, add a link to it in the <code class="w3-codespan">&lt;head&gt;</code> section of each HTML page:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_css_external" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Use of CSS color, font-family and font-size properties:</p>
<div class="w3-code notranslate htmlHigh">
&lt;!DOCTYPE html&gt;<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_css_fonts" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>CSS Border</h2>
<p>The CSS <code class="w3-codespan">border</code> property defines a border 
around an HTML element.</p>
<p><strong>Tip:</strong> You can define a border for nearly all HTML elements.</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Use of CSS border property:&nbsp;</p>
<div class="w3-code notranslate cssHigh">
 p {<br>&nbsp;&nbsp;border: 2px 
solid powderblue;<br>}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_css_borders" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>CSS Padding</h2>
<p>The CSS <code class="w3-codespan">padding</code> property defines a padding 
(space) between the text and the border.</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Use of CSS border and padding properties:</p>
<div class="w3-code notranslate cssHigh">
 p {<br>&nbsp; border: 2px 
solid powderblue;<br>&nbsp; padding: 30px;<br>}</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_css_padding" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>CSS Margin</h2>
<p>The CSS <code class="w3-codespan">margin</code> property defines a margin 
(space) outside the border.</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Use of CSS border and margin properties:</p>
<div class="w3-code notranslate cssHigh">
 p {<br>&nbsp; border: 2px 
solid powderblue;<br>&nbsp;&nbsp;margin: 50px;<br>
 }</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_css_margin" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryhtml_css_external_url" target="_blank">Try it Yourself &raquo;</a></p>
</div>
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryhtml_css_external_relative" target="_blank">Try it Yourself &raquo;</a></p>
</div>
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryhtml_css_external" target="_blank">Try it Yourself &raquo;</a></p>
</div>
...
<hr>
<h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: HTML CSS</h2>
<a href="https://youtu.be/cZHp-Oozg6I&list=PLP9IO4UYNF0VdAajP_5pYG-jG2JRrG72s" class="ga-featured ga-youtube" target="blank_" >
  ...
  <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
    ...
    <img id="yt_div" style="max-width:100%;height:auto;border-radius:6px" src="images/11_html_css.png">
  </div>
</a>
...
<a id="upperfeatureshowcaselink" class="ga-right ga-top-presummer" href="https://campus.w3schools.com/" target="_blank">
<picture id="upperfeatureshowcase">
  <source id="upperfeatureshowcase3001" srcset="/images/img_presummer_up_300.png" media="(max-width: 990px)" style="border-radius: 5px;">
  <source id="upperfeatureshowcase120" srcset="/images/img_presummer_up_120.png" media="(max-width: 1260px)" style="border-radius: 5px;">
  <source id="upperfeatureshowcase160" srcset="/images/img_presummer_up_green_160.png" media="(max-width: 1700px)" style="border-radius: 5px;">
  <img id="upperfeatureshowcase300" src="/images/img_presummer_up_300.png" alt="Get Certified" style="width:auto;border-radius: 5px;">
</picture>
</a>
</div>
...
var upimgsubject1 = "";
var uplink1 = "https://campus.w3schools.com/";
var upclass1 = "ga-top-presummer";
var upimgstart1 = "/images/img_presummer_up_";
var upimgend1 = ".png";
var upimgsubject2 = "";
